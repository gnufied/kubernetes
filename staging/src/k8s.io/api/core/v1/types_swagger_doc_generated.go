...
var map_PodSecurityContext = map[string]string{
	...
	"fsGroupChangePolicy": "FSGroupChangePolicy defines behavior of changing ownership and permission of the volume before being exposed inside Pod. This field will only apply to volume types which support fsGroup based ownership(and permissions). It will have no effect on ephemeral volume types such as: secret, configmaps and emptydir. If not specified - default behaviour is to always recursively change permission and ownership of volume.",
}
