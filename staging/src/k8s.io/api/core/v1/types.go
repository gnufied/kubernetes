...
type VolumeHealthStatus struct {
	...
	// +listMapKey=status
	// +listMapKey=reason
	Conditions []VolumeHealthCondition `json:"conditions,omitempty" protobuf:"bytes,1,rep,name=conditions"`
...
type PodVolumeHealth struct {
	...
	// +listMapKey=status
	// +listMapKey=reason
	Conditions []VolumeHealthCondition `json:"conditions,omitempty" protobuf:"bytes,2,rep,name=conditions"`
	// lastTransitionTime is when the current set of conditions first appeared.
	// +optional
...
type PodSpec struct {
	...
	// WorkloadRef is tombstoned to show why 42 is a reserved protobuf tag.
...
type PodSchedulingGroup struct {
	...
	PodGroupName *string `json:"podGroupName,omitempty" protobuf:"bytes,1,opt,name=podGroupName"`
}
