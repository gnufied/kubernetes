...
func Validate_PodStatus(
	...
	{ // field corev1.PodStatus.VolumeHealth
		fn := func(
			...
			// iterate the list and call the type's validation function
			if e := validate.EachValSliceVal(ctx, op, fldPath, obj, oldObj, nil, nil, Validate_PodVolumeHealth); len(e) != 0 {
				errs = append(errs, e...)
			}
			return
		}
...
func Validate_PodVolumeHealth(
	...
	// field corev1.PodVolumeHealth.Name has no validation
	...
	{ // field corev1.PodVolumeHealth.HealthConditions
		fn := func(
			...
			// iterate the list and call the type's validation function
			if e := validate.EachValSliceVal(ctx, op, fldPath, obj, oldObj, nil, nil, Validate_VolumeHealthCondition); len(e) != 0 {
				errs = append(errs, e...)
			}
			return
		}
...
func Validate_VolumeHealthCondition(
	...
	// field corev1.VolumeHealthCondition.Status has no validation
