...
func (c *csiMountMgr) SetUp(mounterArgs volume.MounterArgs) error {
	return c.setupInternal(c.GetPath(), mounterArgs)
}

func (c *csiMountMgr) SetUpAt(dir string, mounterArgs volume.MounterArgs) error {
	return c.setupInternal(dir, mounterArgs)
}

func (c *csiMountMgr) setupInternal(dir string, mounterArgs volume.MounterArgs) error {
