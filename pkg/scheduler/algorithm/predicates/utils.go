...
// hasVolumeLimits returns a boolean indicating whether the given CSI driver
// is both installed on the node and contains information about volume limits.
func hasVolumeLimits(csiNode *storagev1beta1.CSINode, driverName string) bool {
	if csiNode == nil || len(driverName) == 0 {
		return false
	}
