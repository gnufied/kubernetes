...
func autoConvert_v1alpha1_ExpandControllerConfiguration_To_config_ExpandControllerConfiguration(in *v1alpha1.ExpandControllerConfiguration, out *config.ExpandControllerConfiguration, s conversion.Scope) error {
	out.ConcurrentExpandSyncs = in.ConcurrentExpandSyncs
	return nil
}

// Convert_v1alpha1_ExpandControllerConfiguration_To_config_ExpandControllerConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_ExpandControllerConfiguration_To_config_ExpandControllerConfiguration(in *v1alpha1.ExpandControllerConfiguration, out *config.ExpandControllerConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_ExpandControllerConfiguration_To_config_ExpandControllerConfiguration(in, out, s)
}
...
// Convert_config_ExpandControllerConfiguration_To_v1alpha1_ExpandControllerConfiguration is an autogenerated conversion function.
func Convert_config_ExpandControllerConfiguration_To_v1alpha1_ExpandControllerConfiguration(in *config.ExpandControllerConfiguration, out *v1alpha1.ExpandControllerConfiguration, s conversion.Scope) error {
	return autoConvert_config_ExpandControllerConfiguration_To_v1alpha1_ExpandControllerConfiguration(in, out, s)
}
...
func autoConvert_v1alpha1_KubeControllerManagerConfiguration_To_config_KubeControllerManagerConfiguration(in *v1alpha1.KubeControllerManagerConfiguration, out *config.KubeControllerManagerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ExpandControllerConfiguration_To_config_ExpandControllerConfiguration(&in.ExpandController, &out.ExpandController, s); err != nil {
		return err
	}
...
func autoConvert_config_KubeControllerManagerConfiguration_To_v1alpha1_KubeControllerManagerConfiguration(in *config.KubeControllerManagerConfiguration, out *v1alpha1.KubeControllerManagerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_config_ExpandControllerConfiguration_To_v1alpha1_ExpandControllerConfiguration(&in.ExpandController, &out.ExpandController, s); err != nil {
		return err
	}
