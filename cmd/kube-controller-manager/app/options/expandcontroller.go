...
func (o *ExpandControllerOptions) AddFlags(fs *pflag.FlagSet) {
	...
	fs.Int32Var(&o.ConcurrentExpandSyncs, "concurrent-expand-syncs", o.ConcurrentExpandSyncs, "The number of expand syncing operations that will be done concurrently. Larger number = faster expand updating, but more CPU (and network) load")
}

// ApplyTo fills up ExpandController config with options.
func (o *ExpandControllerOptions) ApplyTo(cfg *kubectrlmgrconfig.ExpandControllerConfiguration) error {
	if o == nil {
		return nil
	}

	cfg.ConcurrentExpandSyncs = o.ConcurrentExpandSyncs
